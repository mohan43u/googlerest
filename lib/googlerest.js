...
var GoogleRest = function(options) {
    this.google_client_id = options.google_client_id || '137500406659-cubikdgci0v2t65obo09n8q5bpj3iooh.apps.googleusercontent.com';
    this.google_client_secret = options.google_client_secret || 'tMWazNthbpjrB-_9x2h1aoy2';
	...
	if(query.error) {
	    ...
	    request({'method': 'post',
			 ...
			 this.google_tokens = JSON.parse(body);
